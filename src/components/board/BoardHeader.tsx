...
export const BoardHeader: React.FC<BoardHeaderProps> = ({ board, onRefresh, expanded, onToggleExpand }) => {
  return (
    <div className="flex items-start justify-between mb-4">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h3 className="text-base font-semibold text-gray-900 leading-tight">{board.name}</h3>
