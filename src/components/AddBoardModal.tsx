    ...
    <Modal isOpen={isOpen} onClose={handleClose}>
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div className="flex items-center justify-end space-x-3 pt-4">
          <Button type="button" variant="ghost" onClick={handleClose} className="px-4 py-2">Cancel</Button>
          <Button type="submit" variant="primary" className="px-4 py-2 flex items-center space-x-2">
            <Plus size={16} />
            <span>Add Board</span>
          </Button>
        </div>
