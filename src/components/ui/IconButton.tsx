...
const colorMap: Record<string, { base: string; active: string }> = {
  default: {
    ...
    active: "bg-gray-200 text-gray-700 shadow-sm",
  },
  green: {
    base: "bg-gray-100 text-gray-500 hover:bg-gray-200",
    active: "bg-green-100 text-green-700 hover:bg-green-200 shadow-sm",
  },
  orange: {
    base: "bg-gray-100 text-gray-500 hover:bg-gray-200",
    active: "bg-orange-100 text-orange-600 hover:bg-orange-200 shadow-sm",
  },
  cyan: {
    base: "bg-gray-100 text-gray-500 hover:bg-gray-200",
    active: "bg-cyan-100 text-cyan-600 hover:bg-cyan-200 shadow-sm",
  },
